export default function Soccer(){
    return(
        <div>
            <h1>Here you will find all things about me concerning soccer.</h1>
            <h2>I have been playing soccer for around 15 years.</h2>
            <h3>Here is a list of my accomplishments: </h3>
            <ul>
                <h3>2009-2018</h3>
                <li>Rec Soccer</li>
                <h3>2015</h3>
                <li>Excelsior International School U13 Team</li>
                <h3>2016</h3>
